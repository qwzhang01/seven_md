...
export function Toolbar() {
  ...
  return (
    <div
      className="flex items-center gap-0 bg-[var(--bg-secondary)] border-b border-[var(--border-default)] select-none"
    ...
    >
      ...
      <div
        ref={containerRef}
        className="flex items-center gap-0 px-2 overflow-x-hidden flex-1 min-w-0"
      ...
      {/* Command Palette + Sidebar Toggle + AI - 右侧固定区域 */}
      <div className="flex items-center gap-0 px-2 shrink-0 border-l border-[var(--border-default)]">
        <ToolbarButton
