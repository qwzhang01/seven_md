# agent-panel-ui Specification

## Purpose

Defines the UI components for the Agent mode in the AIPanel, including the agent tab, message conversation interface, tool call log, patch diff preview, and patch action controls.
